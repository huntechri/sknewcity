                        ...
                        <div className="p-8">
                            ...
                            <div className="my-6">
                                ...
                                <p className="mt-6 text-dark/70 dark:text-white/50">
                                    ...
                                    <Link href="https://sk-new-city.ru" className="hover:text-primary">(https://sk-new-city.ru)</Link>. We refer to their Privacy Statement <Link href="https://sk-new-city.ru" className="hover:text-primary">(https://sk-new-city.ru)</Link>.
                                </p>
