...
import { getBreadcrumbSchema, getFaqSchema, getServiceSchema, renovationFaqs } from "@/lib/seo";


export const metadata: Metadata = {
    title: "Ремонт квартир под ключ в Москве | SK New City",
    description: "СК Новый Город выполняет ремонт квартир под ключ в Москве: капитальный, дизайнерский и косметический ремонт, отделочные работы, смета, гарантия 2 года и контроль качества.",
    alternates: {
        canonical: "/apartment-renovation",
    },
    openGraph: {
        title: "Ремонт квартир под ключ в Москве | SK New City",
        description: "Профессиональный ремонт квартир, отделка и инженерные работы в Москве от СК Новый Город.",
...
export default function ApartmentRenovationPage() {
    const structuredData = [
        getServiceSchema({
            ...
            description: "Полный цикл ремонта квартир: замер, смета, инженерия, отделка, снабжение и авторский контроль.",
