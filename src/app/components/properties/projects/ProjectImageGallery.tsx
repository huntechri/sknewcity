...
export default function ProjectImageGallery({
    ...
    return (
        <>
            <div className="mt-6 grid grid-cols-12 gap-4 sm:mt-8 sm:gap-8">
                {images.slice(0, 4).map((image, index) => (
                    ...
                    >
                        ...
                        <span className="pointer-events-none absolute right-4 top-4 inline-flex items-center gap-2 rounded-full bg-white/90 px-3 py-2 text-sm font-medium text-dark opacity-0 transition group-hover:opacity-100">
                            <Icon icon="ph:magnifying-glass-plus" width={18} height={18} />
                            Открыть
                        </span>
                    </button>
                ))}
