...
const trustItems = [
    {
        ...
        description: "Стоимость работ является фиксированной и не изменяется в процессе выполнения.",
        icon: "ph:scales-bold"
    },
    {
        title: "Работа по договору",
        description: "Заключаем официальный договор с четкой фиксацией сроков, стоимости и обязательств.",
