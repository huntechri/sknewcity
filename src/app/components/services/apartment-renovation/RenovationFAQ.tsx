    ...
    >
      ...
      >
        <div
          ...
          data-oid="w_cwzp1"
        >
          <div className="lg:w-1/3" data-oid="8x:reoj">
            <div className="lg:sticky lg:top-32" data-oid="s7s5mpq">
              <div
          ...
          <div className="lg:w-2/3 w-full lg:min-h-[480px]" data-oid="51-.w0-">
            <Accordion
              type="single"
              collapsible
              ...
              {faqs.map((faq, idx) => (
                ...
                >
                  ...
                  >
                    ...
                    <AccordionContent className="p-0" data-oid="dm49b68">
                      <div
                      ...
                      >
                        ...
                        <div
                          ...
                          data-oid="xolg9f1"
                        >
                          <span data-oid="bphrl9e">Подробнее</span>
                          <Icon
